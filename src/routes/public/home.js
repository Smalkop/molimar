    ...
    <section class="py-24 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="card-hover bg-white rounded-xl overflow-hidden shadow-md">
              ...
              <div class="p-5">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <a href="https://wa.me/${normalizeWhatsApp(settings.whatsapp) || '595981659994'}?text=${encodeURIComponent('Hola, quiero información sobre ' + product.name)}" target="_blank"
        ...
        <div class="text-center mt-12 animate-on-scroll">
          <a href="/productos" class="btn-primary inline-flex items-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg shadow-lg">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="animate-on-scroll">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/${normalizeWhatsApp(settings.whatsapp) || '595981659994'}" target="_blank"
