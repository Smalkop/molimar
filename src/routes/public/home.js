            ...
            <div class="card-hover bg-white rounded-xl overflow-hidden shadow-md">
              ...
              <div class="p-5">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <a href="https://wa.me/${settings.whatsapp || '5491145678901'}?text=${encodeURIComponent('Hola, quiero información sobre ' + product.name)}" target="_blank"
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="animate-on-scroll">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/${settings.whatsapp || '5491145678901'}" target="_blank"
