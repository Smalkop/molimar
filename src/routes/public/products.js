                ...
                <div class="card-hover bg-white rounded-xl overflow-hidden shadow-md border border-gray-100 group">
                  <div class="relative h-56 overflow-hidden bg-gray-100">
                    ...
                    <div class="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0">
                      <a href="https://wa.me/${normalizeWhatsApp(settings.whatsapp) || '595981659994'}?text=${encodeURIComponent('Hola, quiero información sobre ' + product.name)}"
                         target="_blank"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div class="animate-fade-left">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <a href="https://wa.me/${normalizeWhatsApp(settings.whatsapp) || '595981659994'}?text=${encodeURIComponent('Hola, quiero información sobre ' + product.name + ' de Molipar')}"
                 target="_blank"
