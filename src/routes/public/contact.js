              ...
              <div>
                ...
                <div class="space-y-5">
                  ...
                  <div class="flex items-start space-x-4">
                    ...
                    <div><p class="font-medium text-gray-900">WhatsApp</p><a href="https://wa.me/${settings.whatsapp}" target="_blank" class="text-green-600 hover:text-green-700 text-sm mt-1 block">+${settings.whatsapp}</a></div>
                  </div>` : ''}
                </div>
              </div>
