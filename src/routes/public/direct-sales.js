...
const salesRegions = [
  {
    title: 'Acceso desde Guairá',
    phone: '+595 981 659994',
    localities: [
      'Mauricio José Troche (Ruta PY02)',
      'Repatriación',
      'Caaguazú',
      'San Pedro y Canindeyú: San Joaquín, Vaquería, Capiíbary, Curuguaty',
    ],
  },
  {
    title: 'Alto Paraná Norte y Centro (Ruta PY07)',
    phone: '+595 981 199932',
    localities: [
      'Itakyry',
      'Hernandarias',
      'Ciudad del Este',
      'Itapúa (Ruta PY06): Km 30 (Minga Guazú), Tavapy, Santa Rita, Encarnación',
      'Caaguazú y Guairá (Ruta PY02): Tembiaporá, 3 de Febrero, Coronel Oviedo, Santa Teresa, Independencia',
    ],
  },
  {
    title: 'Ruta PY02 (Dr. J. L. Mallorquín hasta Eusebio Ayala)',
    phone: '+595 984 176372',
    localities: [
      'Dr. Juan León Mallorquín',
      'Juan Emilio O\'Leary',
      'San José de los Arroyos',
      'Eusebio Ayala',
      'San Pedro y Canindeyú: Mbutuy, Capiíbary, Yasy Cañy, Laguna Pacova, Guayaibí',
      'Paraguarí y Caazapá: Paraguarí, Quiindy, Caazapá, Yuty',
    ],
  },
  {
            ...
            <div class="card-hover bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
              <div class="bg-primary-600 p-5">
                <div class="flex items-center justify-between">
                  <h3 class="text-lg font-bold text-white">${region.title}</h3>
              ...
              <div class="p-6">
                <div class="flex items-center space-x-3 mb-5 p-3 bg-green-50 rounded-xl">
                  ...
                  <a href="https://wa.me/${region.phone.replace(/\D/g, '')}" target="_blank" rel="noopener noreferrer"
